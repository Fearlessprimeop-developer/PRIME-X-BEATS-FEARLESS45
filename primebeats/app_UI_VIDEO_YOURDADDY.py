...
class PrimeBeats:
    ...
    def _register(self):
        ...
        async def yourdaddy(_,m):
            owner_name = "@Prime_Fearless_45"
            owner_id = "7915543522"
            text = (
                "<b>╭━━━━━━━━━━━━━━━━━━━━╮</b>\n"
                "<b>┃ ⚡ 𝐅ᴇᴀʀʟᴇss ꭗ 𝐎ᴡɴᴇʀ 𝐏ʀᴏғɪʟᴇ</b>\n"
                "<b>╰━━━━━━━━━━━━━━━━━━━━╯</b>\n\n"
                "👑 <b>Owner:</b> <a href=\"https://t.me/Prime_Fearless_45\">@Prime_Fearless_45</a>\n"
                f"🆔 <b>ID:</b> <code>{owner_id}</code>\n"
                "⚡ <b>Status:</b> <code>ONLINE • FEARLESS MODE</code>\n\n"
                "<b>╭─〔 ATTITUDE 〕─╮</b>\n"
                "┃ • No noise. Just results.\n"
                "┃ • Built different. Runs fearless.\n"
                "┃ • The engine speaks when the owner doesn't.\n"
                "┃ • Respect the brand. Respect the grind.\n"
                "╰─────────────────╯\n\n"
                "🚀 <b>PRIME × BEATS</b> • <i>Engineered for the fearless.</i>"
            )
            await m.reply_text(text, reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("👑 𝐎ᴡɴᴇʀ", url="https://t.me/Prime_Fearless_45")],
                [InlineKeyboardButton("⚡ 𝐁ᴀᴄᴋ ᴛᴏ 𝐏ʟᴀʏᴇʀ", callback_data="now")]
            ]))
        ...
        async def callbacks(_,q):
            ...
            elif data=="help:vplay":await q.answer("Use /vplay <YouTube video or video search>",show_alert=True)
            elif data=="yourdaddy":
